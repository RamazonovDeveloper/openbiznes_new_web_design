...
import styles from "./codeDestinationInput.module.css";

export default function CodeDestinationInput() {
  ...
  return (
    <div className={styles.accounts_input}>
      ...
      >
        <div className={styles.accounts_input_main_texts}>Код назначения</div>
        ...
        <div className={styles.accounts_input_modal}>
          ...
          <div>
            <div className={styles.accounts_input_modal_item_modal_item}>
              <h2>08102</h2>
              <p>Оплата налогов и других обязательных  выплат</p>
            </div>
            <div className={styles.accounts_input_modal_item_modal_item}>
              <h2>08102</h2>
              <p>Оплата налогов и других обязательных  выплат</p>
