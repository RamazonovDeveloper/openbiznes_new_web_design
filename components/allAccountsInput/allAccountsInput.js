...
import styles from "./allAccountsInput.module.css";

export default function AllAccountsInput() {
    ...
    <div className={styles.accounts_input}>
      ...
      >
        <div className={styles.accounts_input_main_texts}>
          Все валюты
          <span className={styles.accounts_input_main_texts_span}></span>
          Все счета
        </div>
      ...
      {modal && (
        <div className={styles.accounts_input_modal}>
          <div className={styles.accounts_input_modal_search}>
            ...
            <input type="text" placeholder="Поиск по номеру, виду" />
          </div>
          <div>
            <div className={styles.accounts_input_modal_item}>Выбрать все</div>
            <div className={styles.accounts_input_modal_item}>
              <div
                className={styles.accounts_input_modal_item_main}
                onClick={() => setAmount("UZS")}
              >
                UZS
                <div
                  className={
              ...
              {amount == "UZS" && (
                <div className={styles.accounts_input_modal_item_modal}>
                  <div className={styles.accounts_input_modal_item_modal_item}>
                    <h2>АКБ “Агробанк”</h2>
                    <h2>0000 0000 0000 0000 0000</h2>
