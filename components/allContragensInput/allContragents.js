...
import styles from "./allContragents.module.css";

export default function AllContragentsInput() {
  ...
  return (
    <div className={styles.accounts_input}>
      ...
      >
        <div className={styles.accounts_input_main_texts}>Все контрагенты</div>
        ...
        <div className={styles.accounts_input_modal}>
          ...
          <div>
            <div className={styles.accounts_input_modal_item_modal_item}>
              <h2>ООО “OPEN FUTURE TECHNOLOGY GROUP”</h2>
            </div>
            <div className={styles.accounts_input_modal_item_modal_item}>
              <h2>
                ООО “OPEN FUTURE TECHNOLOGY GROUP OPEN FUTURE TECHNOLOGY GROUP”
              </h2>
            </div>
          </div>
